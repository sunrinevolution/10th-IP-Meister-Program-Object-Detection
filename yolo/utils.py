...
def load_darknet_weights(model, weights_file: str, tiny: bool = False) -> None:
  ...
  for layer_name in layers:
    ...
    for i, layer in enumerate(sub_model.layers):
      ...
      logging.info(f"{sub_model.name}/{layer.name} {'bn' if batch_norm else 'bias'}")
...
def freeze_all(model, frozen : bool = True) -> None:
